// $Id: Preis.h,v 1.25 2005/10/27 13:10:57 christof Exp $
...
public:
	...
	typedef fixedpoint<ManuProC::Precision::Rabatt> rabatt_t;
        ...
        typedef fixedpoint<2> geldbetrag_out;
private:
...
//	if (!stkgr) stkgr=preismenge;
	...
	// braucht man diese Routine wirklich? ich wrde den anderen Gesamtpreis empfehlen
private:
...
Query::Row &operator>>(Query::Row &, Preis &);
#endif
