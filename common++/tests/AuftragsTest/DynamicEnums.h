//  DynamicEnums.h  created 12.12.2002 17:05:43 +1
...
namespace ManuProC {
 namespace DynamicEnums {
  namespace ArtikelTyp {
   enum enum_t {
    gewebtes_Band=0,gefaerbtes_Band=1,bedrucktes_Band=2,aufgemachtes_Band=3,Garn_per_kg=4,Spulen=5,Kartonagen=6,Sonstiges=7,Lohn=8,Farben___Pigmente=9,Etiketten=10,Garn_per_km=11,
   };
  }
  ...
  namespace Waehrung {
   enum enum_t {
    EUR=1,DM=2,USD=3,PND=4,
   };
  }

  namespace Instanzen {
   enum enum_t {
    None=-1,Kundenauftraege=1,Fertigware=2,Prod_Planung=3,Einkauf=4,Weberei=5,
   };
  }

  namespace Kundengruppen {
   enum enum_t {
    None=-1,Kunden=1,Lieferanten=2,Verkaeufer=3,Personen=4,Retif=5,Sonstige=6,
   };
  }
