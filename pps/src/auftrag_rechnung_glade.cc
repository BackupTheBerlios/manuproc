...
{   auftrag_rechnung = this;
   ...
   Gtk::Button *button28 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar7->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Preise\n"
		"setzen", 0, 0, GTK_WIDGET(gnome_stock_pixmap_widget(GTK_WIDGET(toolbar7->gtkobj()), GNOME_STOCK_PIXMAP_SEARCH)), 0, 0));
   ...
   table10->attach(*label66, 3, 4, 1, 3, GTK_FILL, 0, 0, 0);
   table10->attach(*rng_waehrung, 4, 5, 1, 3, GTK_FILL, 0, 0, 0);
   ...
   scrolledwindow7->add(*offene_lieferscheine);
   vbox8->pack_start(*table11, false, true, 0);
   vbox8->pack_start(*scrolledwindow7);
   ...
   button28->clicked.connect(SigC::slot(static_cast<class auftrag_rechnung*>(this), &auftrag_rechnung::Preis_setzen));
   ...
   glademm_set_Widget("auftrag_rechnung", this);
}
