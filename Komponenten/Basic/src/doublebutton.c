// $Id: doublebutton.c,v 1.1 2003/04/07 16:01:04 christof Exp $
...
GType          doublebutton_get_type          (void) G_GNUC_CONST
{
  ...
  if (!button_type)
	...
	NULL,		/* base_init */
	NULL,		/* base_finalize */
	(GClassInitFunc) double_button_class_init,
	NULL,		/* class_finalize */
	NULL,		/* class_data */
	sizeof (DoubleButton),
	0,		/* n_preallocs */
...
void double_button_class_init(DoubleButtonClass *klass)
...
//   klass->secondpressed = doublebutton_secondpressed
   ...
   doublebutton_signals[SECONDPRESSED]= g_signal_new ("secondpressed",
                  ...
                  G_SIGNAL_RUN_FIRST,
                  G_STRUCT_OFFSET (GtkButtonClass, secondpressed),
                  NULL, NULL,
