...
// for gtk 2.4.13 and gtkmm 2.4.7
//
...
{  
   ...
   tree = new class SimpleTree(MAXCOLUMN);
   ...
   Gtk::Label *label1 = Gtk::manage(new class Gtk::Label("Zeige Artikel der Instanz"));
   ...
   table9->attach(*label1, 1, 2, 0, 1, Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   ...
   tree->signal_unselect_row().connect(SigC::slot(*this, &Artikeleingabe_glade::on_unselect_row), false);
