// generated 2004/2/9 15:09:35 CET by jacek@jaceksdell.(none)
...
{  buchen_dialog = this;
   ...
   label119 = manage(new class Gtk::Label("Der Lieferschein ist noch nicht im Lager gebucht.\n"
   ...
   hbox34->pack_start(*label119, false, false, 0);
