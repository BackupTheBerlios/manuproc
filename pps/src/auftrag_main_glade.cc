...
{  auftrag_main = this;
   ...
   table24->attach(*button_instanz_get_selection, 3, 4, 1, 3, 0, 0, 0, 0);
   table24->attach(*label75, 1, 2, 1, 2, 0, 0, 0, 0);
   table24->attach(*button_instanz_print, 4, 5, 1, 3, GTK_FILL, 0, 0, 0);
   table24->attach(*kunden_lieferant, 0, 5, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table18->attach(*frame13, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, 0, 10, 0);
   table18->attach(*frame15, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   togglebutton_geplante_menge->toggled.connect(SigC::slot(this, &auftrag_main_glade::on_togglebutton_geplante_menge_toggled));
