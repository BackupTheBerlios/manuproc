// generated 2006/2/7 13:10:37 CET by jacek@shindo-debian.(none)
...
{  
   ...
   Gtk::ToolButton *toolbutton6 = Gtk::manage(new class Gtk::ToolButton(Gtk::StockID("gtk-close")));
#endif //
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   Gtk::ToolButton *toolbutton2 = Gtk::manage(new class Gtk::ToolButton(*toolbutton2_img, _("Neu")));
#endif //
   Gtk::Image *toolbutton_delete_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-delete"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolbutton_delete = Gtk::manage(new class Gtk::ToolButton(*toolbutton_delete_img, _("Löschen")));
#endif //
   
   Gtk::Image *toolbutton4_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-remove"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   Gtk::ToolButton *toolbutton4 = Gtk::manage(new class Gtk::ToolButton(*toolbutton4_img, _("Entfernen")));
#endif //
   ...
   Gtk::Label *label97 = Gtk::manage(new class Gtk::Label(_("Adressen außerhalb der Gruppe")));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolbar8->append(*toolbutton6);
#else //
   
   
   toolbar8->tools().push_back(Gtk::Toolbar_Helpers::StockElem(Gtk::StockID("gtk-close"), Gtk::Toolbar_Helpers::Callback0()));
   Gtk::Button *toolbutton6 = static_cast<Gtk::Button *>(toolbar8->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   ...
   toolbar6->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Neu"), *toolbutton2_img, Gtk::Toolbar_Helpers::Callback0()));
   Gtk::Button *toolbutton2 = static_cast<Gtk::Button *>(toolbar6->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolbar6->append(*toolbutton_delete);
#else //
   
   
   toolbar6->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Löschen"), *toolbutton_delete_img, Gtk::Toolbar_Helpers::Callback0()));
   toolbutton_delete = static_cast<Gtk::Button *>(toolbar6->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   ...
   toolbar6->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Entfernen"), *toolbutton4_img, Gtk::Toolbar_Helpers::Callback0()));
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolbutton6->add_accelerator("clicked", gmm_data->getAccelGroup(), GDK_W, Gdk::CONTROL_MASK, Gtk::ACCEL_VISIBLE);
   toolbutton6->set_visible_horizontal(true);
   toolbutton6->set_visible_vertical(true);
   toolbutton6->set_is_important(false);
   toolbutton6->set_homogeneous(true);
   toolbutton6->set_expand(false);
#endif //
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolbutton_delete->set_sensitive(false);
   _tooltips.set_tip(*toolbutton_delete, _("Gruppe löschen"), "");
   toolbutton_delete->set_visible_horizontal(true);
   toolbutton_delete->set_visible_vertical(true);
   toolbutton_delete->set_is_important(false);
   toolbutton_delete->set_homogeneous(true);
   toolbutton_delete->set_expand(false);
   toolbutton_delete->set_tooltip(_tooltips, _("Gruppe löschen"));
#endif //
   toolbutton_delete_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   _tooltips.set_tip(*toolbutton4, _("ausgewählte Adressen aus Gruppe herausnehmen"), "");
   ...
   toolbutton4->set_tooltip(_tooltips, _("ausgewählte Adressen aus Gruppe herausnehmen"));
#endif //
...
#endif //
   hbox21->pack_start(*toolbar8, Gtk::PACK_SHRINK, 0);
   ...
   scrolledwindow12->set_shadow_type(Gtk::SHADOW_NONE);
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   _tooltips.set_tip(*toolbutton5, _("ausgewählte Adressen zur Gruppe hinzufügen"), "");
   ...
   toolbutton5->set_tooltip(_tooltips, _("ausgewählte Adressen zur Gruppe hinzufügen"));
#endif //
   ...
   scrolledwindow13->set_shadow_type(Gtk::SHADOW_NONE);
   ...
   scrolledwindow13->add(*anderekunden);
   vbox15->pack_start(*toolbar7, Gtk::PACK_SHRINK, 0);
   vbox15->pack_start(*scrolledwindow13);
   ...
   vbox14->pack_start(*scrolledwindow12);
   vbox14->pack_start(*expander_nicht);
   window_kundengruppen->set_title(_("Adressgruppen"));
   window_kundengruppen->set_default_size(800,600);
   ...
   toolbutton6->signal_clicked().connect(SigC::slot(*this, &window_kundengruppen_glade::on_schliessen_clicked), false);
   ...
   toolbutton_delete->signal_clicked().connect(SigC::slot(*this, &window_kundengruppen_glade::loeschen), false);
