// generated 2001/9/11 15:21:18 CEST by thoma@Tiger.
...
{   auftrag_main = this;
   ...
   table_prod_prozess = manage(new class Gtk::Table(1, 2, false));
   ...
   vbox3->pack_start(*scrolledwindow_maintree_s);
   vbox3->pack_start(*table_instanzen);
   ...
   vbox2->pack_start(*table_prod_prozess, false, true, 0);
