...
{   auftrag_main = this;
   ...
   {   
      ...
      {        { GNOME_APP_UI_RADIOITEMS, 0, 0,  main_kndbez_uiinfo, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  0, (GdkModifierType)0, 0 },
	      ...
	      { GNOME_APP_UI_TOGGLEITEM, "Geplanter Materialbedarf", 0,  0, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  0, (GdkModifierType)0, 0 },
	      GNOMEUIINFO_SEPARATOR, 
      ...
      geplanter_materialbedarf = Gtk::wrap(GTK_CHECK_MENU_ITEM(main_einstellungen_menu_uiinfo[11].widget));
      trennlinie8 = Gtk::wrap(GTK_MENU_ITEM(main_einstellungen_menu_uiinfo[12].widget));
   }
