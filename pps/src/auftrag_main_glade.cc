// generated 2002/9/24 10:09:57 MEST by jacek@ijacek.jacek.de
...
{  auftrag_main = this;
   ...
   vbox8->pack_start(*hpaned_tree_lager);
   ...
   label82->set_justify(GTK_JUSTIFY_CENTER);
   ...
   togglebutton_geplante_menge->set_relief(GTK_RELIEF_NORMAL);
   ...
   table16->set_row_spacings(0);
   table16->set_col_spacings(0);
   ...
   tree_lager_frei->leaf_selected.connect(SigC::slot(static_cast<class auftrag_main*>(this), &auftrag_main::on_lager_leaf_selected));
   tree_lager_frei->unselect_row.connect(SigC::slot(static_cast<class auftrag_main*>(this), &auftrag_main::on_lager_unselect_row));
   tree_lager_frei->node_selected.connect(SigC::slot(static_cast<class auftrag_main*>(this), &auftrag_main::on_lager_node_selected));
   tree_lager_verplant->leaf_selected.connect(SigC::slot(static_cast<class auftrag_main*>(this), &auftrag_main::on_lager_leaf_selected));
   tree_lager_verplant->unselect_row.connect(SigC::slot(static_cast<class auftrag_main*>(this), &auftrag_main::on_lager_unselect_row));
   tree_lager_verplant->node_selected.connect(SigC::slot(static_cast<class auftrag_main*>(this), &auftrag_main::on_lager_node_selected));
   endemain_button->clicked.connect(SigC::slot(static_cast<class auftrag_main*>(this), &auftrag_main::on_beenden_activate));
   mainprint_button->button_press_event.connect(SigC::slot(static_cast<class auftrag_main*>(this), &auftrag_main::on_mainprint_button_clicked));
