// generated 2005/9/12 12:40:08 CEST by jacek@woody.mabella.de
...
{  auftrag_rechnung = this;
   ...
   toolbar7->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Preis ergänzen", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_SEARCH)), 0));
   ...
   toolbar14->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Lfrs. aufräumen", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_CLEAR)), 0));
