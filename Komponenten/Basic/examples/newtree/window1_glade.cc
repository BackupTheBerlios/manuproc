// generated 2002/12/11 17:09:02 CET by christof@puck.petig-baender.de
...
{  window1 = this;
   ...
   Gtk::Image *image6 = manage(new class Gtk::Image(Gtk::StockID("gtk-execute"), Gtk::IconSize(4)));
   Gtk::Label *label6 = manage(new class Gtk::Label("viel ändern"));
   Gtk::HBox *hbox6 = manage(new class Gtk::HBox(false, 2));
   Gtk::Alignment *alignment6 = manage(new class Gtk::Alignment());
   Gtk::Button *button4 = manage(new class Gtk::Button());
   Gtk::Image *image5 = manage(new class Gtk::Image(Gtk::StockID("gtk-execute"), Gtk::IconSize(4)));
   Gtk::Label *label5 = manage(new class Gtk::Label("wenig ändern"));
   Gtk::HBox *hbox5 = manage(new class Gtk::HBox(false, 2));
   Gtk::Alignment *alignment5 = manage(new class Gtk::Alignment());
   Gtk::Button *button5 = manage(new class Gtk::Button());
