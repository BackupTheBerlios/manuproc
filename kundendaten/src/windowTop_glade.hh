...
protected:
        ...
        class SearchComboContent<int> *custom1;
	   ...
	   {  BANKNAME, 
        ...
        class SimpleTree *gewaehlt_gruppen;
...
private:
        ...
        virtual void on_selectrow_gewaehltgruppen(cH_RowDataBase leaf) = 0;
        virtual void on_unselectrow_gewaehltgruppen(gint row, gint column, GdkEvent *event) = 0;
