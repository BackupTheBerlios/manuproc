...
{  
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Export Order", *manage(new Gtk::Image(Gtk::StockID("gtk-jump-to"), Gtk::ICON_SIZE_LARGE_TOOLBAR)), Gtk::Toolbar_Helpers::Callback0()));
