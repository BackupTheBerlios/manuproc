// generated 2002/9/23 12:19:20 MEST by jacek@ijacek.jacek.de
...
{  auftrag_rechnung = this;
   ...
   _data = new GlademmData(auftrag_rechnung_accgrp);
   ...
   {  static GnomeUIInfo menuitem1_menu_uiinfo[] = 
      ...
      gnome_app_fill_menu(GTK_MENU_SHELL(menubar3->gtkobj()), menubar3_uiinfo, _data->getAccelGroup()->gtkobj(), true, 0);
   ...
   toolbar8->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Lieferschein übernehmen", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_ATTACH)), 0));
   ...
   table23->attach(*zahlziel, 1, 2, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table25->attach(*frame_rechnung, 0, 1, 2, 3, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table25->attach(*toolbar7, 0, 1, 1, 2, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table25->attach(*frame9, 0, 1, 4, 5, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table25->attach(*frame_rechnungsdaten, 0, 1, 3, 4, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   auftrag_rechnung->add_accel_group(*(_data->getAccelGroup()));
   ...
   zahlziel->activate.connect(SigC::slot(static_cast<class auftrag_rechnung*>(this), &auftrag_rechnung::on_zahlziel_activate));
   ...
   checkbutton_ean_drucken->clicked.connect_after(SigC::slot(static_cast<class auftrag_rechnung*>(this), &auftrag_rechnung::on_checkbutton_ean_drucken_clicked));
   ...
   button_allopen->clicked.connect(SigC::slot(static_cast<class auftrag_rechnung*>(this), &auftrag_rechnung::on_button_allopen_clicked));
   button_lieferscheine_aufraumen->clicked.connect(SigC::slot(static_cast<class auftrag_rechnung*>(this), &auftrag_rechnung::on_button_lieferscheine_aufraumen_clicked));
