// generated 2005/12/5 18:30:32 CET by christof@vesta.petig-baender.de
...
{  
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolbutton_delete = Gtk::manage(new class Gtk::ToolButton(*toolbutton_delete_img, ""));
#endif //
   ...
   toolbar6->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *toolbutton_delete_img, Gtk::Toolbar_Helpers::Callback0()));
