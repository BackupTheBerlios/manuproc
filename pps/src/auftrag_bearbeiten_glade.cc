// generated 2003/10/17 13:38:44 CEST by jacek@jaceksdell.(none)
...
{  auftrag_bearbeiten = this;
   ...
   Gtk::Button *button32 = manage(new class Gtk::Button("L:"));
   ...
   button32->set_flags(GTK_CAN_FOCUS);
   _tooltips.set_tip(*button32, "Lagerbestand", "");
   button32->set_relief(GTK_RELIEF_NORMAL);
   ...
   table28->attach(*button32, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
