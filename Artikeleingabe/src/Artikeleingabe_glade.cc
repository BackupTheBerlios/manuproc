// generated 2005/10/28 20:19:38 CEST by christof@vesta.petig-baender.de
...
{  
   ...
   table_preis = Gtk::manage(new class table_preis(gmm_data));
   ...
   button_artikel_delete->set_homogeneous(true);
   button_artikel_delete->set_expand(false);
#endif //
   ...
   button_artikel_wechsel->set_homogeneous(true);
   button_artikel_wechsel->set_expand(false);
#endif //
   button_artikel_wechsel_img->show();
   toolbar_loeschen->set_border_width(5);
   toolbar_loeschen->set_tooltips(true);
   toolbar_loeschen->set_toolbar_style(Gtk::TOOLBAR_BOTH);
   ...
   button_verschmelzen->set_homogeneous(true);
   button_verschmelzen->set_expand(false);
#endif //
...
{  table_preis = this;
   ...
   image_preis_ok = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-add"), Gtk::IconSize(4)));
   ...
   table_preis->attach(*hbox5, 0, 1, 2, 3, Gtk::FILL, Gtk::FILL, 0, 0);
   table_preis->attach(*preisliste, 0, 1, 0, 1, Gtk::FILL, Gtk::FILL, 0, 0);
   hseparator1->show();
   preisstaffel->show();
