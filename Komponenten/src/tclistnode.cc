...
// $Id: tclistnode.cc,v 1.10 2001/04/20 07:10:55 christof Exp $
...
TCListNode::TCListNode(int _seqnr, const cH_RowDataBase &v, 
			int deep) :
	TCListRowData(v->Value(_seqnr),deep,false),show(false)
{}
...
void TCListNode::resetSumValues(gpointer p)
{
 sumvalue=((TCListNode*)p)->SumValue();
}
