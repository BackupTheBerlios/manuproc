// generated 2003/3/26 10:23:22 MET by jacek@ijacek.jacek.de
...
{  
   ...
   Gtk::RadioMenuItem::Group _RadioBGroup_zeit;
   radiobutton_alle_zeit_von = manage(new class Gtk::RadioButton(_RadioBGroup_zeit,
   	 std::string("Zeige vom Anfang"), (gfloat)0, (gfloat)0.5));
   radiobutton_nur_zeit_von = manage(new class Gtk::RadioButton(_RadioBGroup_zeit,
   	 std::string("Zeige vom"), (gfloat)0, (gfloat)0.5));
   Wdatum_von = new class Datewin();
   
   Gtk::VBox *fixed2 = manage(new class Gtk::VBox(false, 0));
   Gtk::RadioMenuItem::Group _RadioBGroup_zeit_2;
   radiobutton_alle_zeit_bis = manage(new class Gtk::RadioButton(_RadioBGroup_zeit_2, std::string("bis heute"), (gfloat)0, (gfloat)0.5));
   radiobutton_nur_zeit_bis = manage(new class Gtk::RadioButton(_RadioBGroup_zeit_2, std::string("bis zum"), (gfloat)0, (gfloat)0.5));
   ...
   Gtk::RadioMenuItem::Group _RadioBGroup_artikel;
   radiobutton_alle_artikel = manage(new class Gtk::RadioButton(_RadioBGroup_artikel, std::string("Zeige alle Artikel"), (gfloat)0, (gfloat)0.5));
   radiobutton_nur_artikel = manage(new class Gtk::RadioButton(_RadioBGroup_artikel, std::string("Zeige nur Artikel"), (gfloat)0, (gfloat)0.5));
   first_komponent = manage(new class Gtk::CheckButton(std::string("nur Art.Nr. einschr‰nken"), (gfloat)0, (gfloat)0.5));
   ...
   Gtk::RadioMenuItem::Group _RadioBGroup_kunde;
   radiobutton_alle_kunden = manage(new class Gtk::RadioButton(_RadioBGroup_kunde, std::string("Zeige alle Kunden"), (gfloat)0, (gfloat)0.5));
   radiobutton_nur_kunde = manage(new class Gtk::RadioButton(_RadioBGroup_kunde, std::string("Zeige nur Kunde"), (gfloat)0, (gfloat)0.5));
   ...
   fixed3->pack_start(*radiobutton_nur_kunde, false, true, 0);
   fixed3->pack_start(*kundenbox);
   ...
   table14->attach(*table15, 0, 1, 1, 2, 0, 0, 0, 0);
