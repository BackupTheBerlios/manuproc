// generated 2004/10/22 18:13:52 CEST by jacek@jaceksdell.(none)
...
{  
   ...
   Gtk::Image *beenden_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-quit"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   Gtk::ToolButton *beenden = Gtk::manage(new class Gtk::ToolButton(*beenden_img, "Quit"));
#endif //
   Gtk::Image *neu_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-new"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   neu = Gtk::manage(new class Gtk::ToolButton(*neu_img, "New Order"));
#endif //
   
   Gtk::Image *senden_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-jump-to"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   Gtk::ToolButton *senden = Gtk::manage(new class Gtk::ToolButton(*senden_img, "Export Order"));
#endif //
   Gtk::Image *clear_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-clear"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   clear = Gtk::manage(new class Gtk::ToolButton(*clear_img, "Clear"));
#endif //
   
   Gtk::Toolbar *toolbar1 = Gtk::manage(new class Gtk::Toolbar());
   kunde = Gtk::manage(new class Gtk::Entry());
   
   Gtk::Image *customer_search_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-find"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   Gtk::ToolButton *customer_search = Gtk::manage(new class Gtk::ToolButton(*customer_search_img, "Search"));
#endif //
   ...
   orderid = Gtk::manage(new class Gtk::Entry());
   ...
   article_entry = Gtk::manage(new class Gtk::Entry());
   ...
   width_entry = Gtk::manage(new class Gtk::Entry());
   ...
   ean_entry = Gtk::manage(new class Gtk::Entry());
   ...
   Gtk::Image *artikel_ok_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-ok"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   artikel_ok = Gtk::manage(new class Gtk::ToolButton(*artikel_ok_img, "OK"));
#endif //
   
   Gtk::Image *artikel_cancel_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-cancel"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   Gtk::ToolButton *artikel_cancel = Gtk::manage(new class Gtk::ToolButton(*artikel_cancel_img, "Cancel"));
#endif //
   Gtk::Toolbar *toolbar2 = Gtk::manage(new class Gtk::Toolbar());
   Gtk::Image *artikel_del_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-delete"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   artikel_del = Gtk::manage(new class Gtk::ToolButton(*artikel_del_img, "delete row"));
#endif //
   ...
   order = Gtk::manage(new class Gtk::TreeView());
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbar1->append(*beenden);
#else //
   
   
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Quit", *beenden_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("New Order", *neu_img, Gtk::Toolbar_Helpers::Callback0()));
   neu = static_cast<Gtk::Button *>(toolbar1->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbar1->append(*senden);
#else //
   
   
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Export Order", *senden_img, Gtk::Toolbar_Helpers::Callback0()));
   Gtk::Button *senden = static_cast<Gtk::Button *>(toolbar1->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbar1->append(*clear);
#else //
   
   
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Clear", *clear_img, Gtk::Toolbar_Helpers::Callback0()));
   clear = static_cast<Gtk::Button *>(toolbar1->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbar3->append(*customer_search);
#else //
   
   
   toolbar3->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Search", *customer_search_img, Gtk::Toolbar_Helpers::Callback0()));
   Gtk::Button *customer_search = static_cast<Gtk::Button *>(toolbar3->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbar2->append(*artikel_ok);
#else //
   
   
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("OK", *artikel_ok_img, Gtk::Toolbar_Helpers::Callback0()));
   artikel_ok = static_cast<Gtk::Button *>(toolbar2->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbar2->append(*artikel_cancel);
#else //
   
   
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Cancel", *artikel_cancel_img, Gtk::Toolbar_Helpers::Callback0()));
   Gtk::Button *artikel_cancel = static_cast<Gtk::Button *>(toolbar2->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbar4->append(*artikel_del);
#else //
   
   
   toolbar4->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("delete row", *artikel_del_img, Gtk::Toolbar_Helpers::Callback0()));
   artikel_del = static_cast<Gtk::Button *>(toolbar4->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   beenden->set_size_request(60,-1);
   beenden->set_visible_horizontal(true);
   beenden->set_visible_vertical(true);
   beenden->set_is_important(false);
#endif //
   beenden_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   neu->set_sensitive(false);
   neu->set_visible_horizontal(true);
   neu->set_visible_vertical(true);
   neu->set_is_important(false);
#endif //
   neu_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   senden->set_visible_horizontal(true);
   senden->set_visible_vertical(true);
   senden->set_is_important(false);
#endif //
   senden_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   clear->set_visible_horizontal(true);
   clear->set_visible_vertical(true);
   clear->set_is_important(false);
#endif //
   clear_img->show();
   toolbar1->set_tooltips(true);
   toolbar1->set_toolbar_style(Gtk::TOOLBAR_BOTH);
   toolbar1->set_orientation(Gtk::ORIENTATION_HORIZONTAL);
   kunde->set_flags(Gtk::CAN_FOCUS);
   kunde->set_visibility(true);
   kunde->set_editable(true);
   kunde->set_max_length(0);
   kunde->set_text("");
   kunde->set_has_frame(true);
   kunde->set_activates_default(false);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   customer_search->set_visible_horizontal(true);
   customer_search->set_visible_vertical(true);
   customer_search->set_is_important(false);
#endif //
   customer_search_img->show();
   ...
   table1->attach(*orderid, 2, 3, 0, 1, Gtk::EXPAND|Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   ...
   article_entry->set_flags(Gtk::CAN_FOCUS);
   article_entry->set_visibility(true);
   article_entry->set_editable(true);
   article_entry->set_max_length(0);
   article_entry->set_text("");
   article_entry->set_has_frame(true);
   article_entry->set_activates_default(false);
   ...
   width_entry->set_flags(Gtk::CAN_FOCUS);
   width_entry->set_visibility(true);
   width_entry->set_editable(true);
   width_entry->set_max_length(0);
   width_entry->set_text("");
   width_entry->set_has_frame(true);
   width_entry->set_activates_default(false);
   ...
   clor_entry->set_flags(Gtk::CAN_FOCUS);
   clor_entry->set_visibility(true);
   clor_entry->set_editable(true);
   clor_entry->set_max_length(0);
   clor_entry->set_text("");
   clor_entry->set_has_frame(true);
   clor_entry->set_activates_default(false);
   ...
   frame9->add(*clor_entry);
   frame9->set_label_widget(*label15);
   makeup_entry->set_flags(Gtk::CAN_FOCUS);
   makeup_entry->set_visibility(true);
   makeup_entry->set_editable(true);
   makeup_entry->set_max_length(0);
   makeup_entry->set_text("");
   makeup_entry->set_has_frame(true);
   makeup_entry->set_activates_default(false);
   ...
   ean_entry->set_flags(Gtk::CAN_FOCUS);
   ean_entry->set_visibility(true);
   ean_entry->set_editable(true);
   ean_entry->set_max_length(0);
   ean_entry->set_text("");
   ean_entry->set_has_frame(true);
   ean_entry->set_activates_default(false);
   ...
   artikel_ok->set_visible_horizontal(true);
   artikel_ok->set_visible_vertical(true);
   artikel_ok->set_is_important(false);
#endif //
   artikel_ok_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   artikel_cancel->set_flags(Gtk::CAN_FOCUS);
   artikel_cancel->set_visible_horizontal(true);
   artikel_cancel->set_visible_vertical(true);
   artikel_cancel->set_is_important(false);
#endif //
   artikel_cancel_img->show();
   ...
   artikel_del->set_visible_horizontal(true);
   artikel_del->set_visible_vertical(true);
   artikel_del->set_is_important(false);
#endif //
   artikel_del_img->show();
   ...
   order->set_flags(Gtk::CAN_FOCUS);
   order->set_headers_visible(true);
   order->set_rules_hint(false);
   order->set_reorderable(false);
   order->set_enable_search(true);
   ...
   vbox1->show();
   mpc_agent->show();
   beenden->signal_clicked().connect(SigC::slot(*this, &mpc_agent_glade::on_beenden_activate), false);
   neu->signal_clicked().connect(SigC::slot(*this, &mpc_agent_glade::on_neu_clicked), false);
   senden->signal_clicked().connect(SigC::slot(*this, &mpc_agent_glade::on_senden_clicked), false);
   clear->signal_clicked().connect(SigC::slot(*this, &mpc_agent_glade::on_clear_activate), false);
   customer_search->signal_clicked().connect(SigC::slot(*this, &mpc_agent_glade::on_customer_search_clicked), false);
   menge->signal_activate().connect(SigC::slot(*this, &mpc_agent_glade::on_menge_editing_done), true);
   artikel_ok->signal_clicked().connect(SigC::slot(*this, &mpc_agent_glade::on_artikel_ok_clicked), false);
   artikel_cancel->signal_clicked().connect(SigC::slot(*this, &mpc_agent_glade::on_artikel_cancel_clicked), false);
   artikel_del->signal_clicked().connect(SigC::slot(*this, &mpc_agent_glade::on_artikel_del_clicked), false);
}
