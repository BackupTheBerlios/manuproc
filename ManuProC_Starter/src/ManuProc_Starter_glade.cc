// generated 2006/2/7 10:56:13 CET by jacek@shindo-debian.(none)
...
{  
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   kunden_neu_start = Gtk::manage(new class Gtk::ToolButton(*kunden_neu_start_img, "Kunden Gtk-2"));
#endif //
   ...
   toolbar3->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Kunden Gtk-2", *kunden_neu_start_img, Gtk::Toolbar_Helpers::Callback0()));
