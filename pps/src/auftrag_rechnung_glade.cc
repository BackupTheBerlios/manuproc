// generated 2005/9/8 13:28:55 CEST by jacek@jaceksdell.(none)
...
{  auftrag_rechnung = this;
   ...
   Gtk::Label *label66 = manage(new class Gtk::Label(""));
   ...
   entsorgung = manage(new class Gtk::CheckButton("Ents.-Pausch.", 0, 0.5));
   
   Gtk::Table *table28 = manage(new class Gtk::Table(8, 3, false));
   frame_betrag = manage(new class Gtk::Frame("Rechnungsbetrag"));
   ...
   toolbar7->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_CLOSE)), 0));
   ...
   toolbar7->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_SEARCH)), 0));
   preis_ergaenzen = static_cast<Gtk::Button *>(toolbar7->tools().back()->get_widget());
   toolbar7->tools().push_back(Gtk::Toolbar_Helpers::Space());
   
   
   toolbar7->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_CLEAR)), 0));
   ...
   toolbar14->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_CLEAR)), 0));
   button_lieferscheine_aufraumen = static_cast<Gtk::Button *>(toolbar14->tools().back()->get_widget());
   
   toolbar8->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_ATTACH)), 0));
   ...
   label_rechnung_ctl->set_justify(GTK_JUSTIFY_CENTER);
   ...
   table28->attach(*label114, 0, 1, 6, 7, GTK_FILL, 0, 0, 0);
   table28->attach(*label115, 0, 1, 7, 8, GTK_FILL, 0, 0, 0);
   table28->attach(*label_waehrung6, 2, 3, 6, 7, GTK_FILL, 0, 0, 0);
   table28->attach(*label_waehrung7, 2, 3, 7, 8, GTK_FILL, 0, 0, 0);
   table28->attach(*rgbetrag_rabatt, 1, 2, 1, 2, 0, 0, 0, 0);
   table28->attach(*rgbetrag_mwst, 1, 2, 6, 7, 0, 0, 0, 0);
   table28->attach(*rgbetrag_endsumme, 1, 2, 7, 8, 0, 0, 0, 0);
   table28->attach(*label116, 0, 1, 4, 5, GTK_FILL, 0, 0, 0);
   table28->attach(*label117, 0, 1, 5, 6, GTK_FILL, 0, 0, 0);
   table28->attach(*label_waehrung3, 2, 3, 2, 3, GTK_FILL, 0, 0, 0);
   table28->attach(*label_waehrung4, 2, 3, 4, 5, GTK_FILL, 0, 0, 0);
   table28->attach(*label_waehrung5, 2, 3, 5, 6, GTK_FILL, 0, 0, 0);
   table28->attach(*rgbetrag_zusabs, 1, 2, 4, 5, 0, 0, 0, 0);
   table28->attach(*rgbetrag_zwsumme, 1, 2, 5, 6, 0, 0, 0, 0);
   table28->attach(*entsorgung, 0, 3, 3, 4, 0, 0, 0, 0);
   frame_betrag->set_usize(180,-1);
   frame_betrag->set_border_width(3);
   frame_betrag->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame_betrag->set_label_align(0,0);
   frame_betrag->add(*table28);
   hbox33->pack_start(*frame_rechnungsdaten);
   hbox33->pack_start(*frame_betrag, false, true, 0);
   ...
   entsorgung->toggled.connect_after(SigC::slot(this, &auftrag_rechnung_glade::on_entsorgung_toggled));
