// generated 2001/9/12 13:15:00 CEST by thoma@Tiger.
...
{   auftrag_bearbeiten = this;
   ...
   table_auftragseintraege->attach(*label73, 3, 4, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   table_auftragseintraege->attach(*rabattentry_spinbutton, 2, 3, 1, 2, 0, 0, 0, 0);
   table_auftragseintraege->attach(*WAufEntryStat, 8, 9, 3, 4, GTK_FILL, GTK_FILL, 0, 0);
   table_auftragseintraege->attach(*WPreis, 0, 1, 1, 3, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
