// generated 2002/3/15 12:48:07 CET by thoma@Tiger.
...
{   auftrag_main = this;
   ...
   {   
      ...
      trennlinie7 = Gtk::wrap(GTK_MENU_ITEM(main_einstellungen_menu_uiinfo[5].widget));
      trennlinie4 = Gtk::wrap(GTK_MENU_ITEM(main_einstellungen_menu_uiinfo[7].widget));
      trennlinie6 = Gtk::wrap(GTK_MENU_ITEM(main_einstellungen_menu_uiinfo[9].widget));
      trennlinie8 = Gtk::wrap(GTK_MENU_ITEM(main_einstellungen_menu_uiinfo[11].widget));
   }
   ...
   Gtk::Table *table19 = manage(new class Gtk::Table(3, 4, false));
   ...
   maintree_s = new class SimpleTree(11, 9);
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::Space());
   button_auftrag_erledigt = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar1->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Auftrag", 0, 0, GTK_WIDGET(gnome_stock_pixmap_widget(GTK_WIDGET(toolbar1->gtkobj()), GNOME_STOCK_PIXMAP_TRASH)), 0, 0));
   button_Kunden_erledigt = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar1->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Aufträge", 0, 0, GTK_WIDGET(gnome_stock_pixmap_widget(GTK_WIDGET(toolbar1->gtkobj()), GNOME_STOCK_PIXMAP_TRASH_FULL)), 0, 0));
   ...
   table19->attach(*label75, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table19->attach(*searchcombo_auftragid, 0, 1, 2, 3, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table19->attach(*label85, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table19->attach(*Datum_instanz, 1, 2, 2, 3, GTK_FILL, GTK_FILL, 0, 0);
   table19->attach(*button_neue_anr, 2, 3, 1, 3, GTK_FILL, 0, 5, 3);
   table19->attach(*button_instanz_print, 3, 4, 1, 3, GTK_FILL, 0, 5, 0);
   table19->attach(*kunden_lieferant, 0, 4, 0, 1, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   alignment1->add(*table19);
   frame14->set_label_align(0, 0);
   frame14->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame14->add(*alignment1);
