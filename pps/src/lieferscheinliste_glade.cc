// generated 2001/9/19 17:52:47 CEST by thoma@tigerisdn.
...
{   
   ...
   radiobutton_nur_kunde = manage(new class Gtk::RadioButton(_RadioBGroup_kunde, "Zeige nur Kunde"));
   radiobutton_alle_kunden = manage(new class Gtk::RadioButton(_RadioBGroup_kunde, "Zeige alle Kunden"));
   ...
   radiobutton_alle_zeit_bis = manage(new class Gtk::RadioButton(_RadioBGroup_zeit_2, "bis heute"));
   radiobutton_nur_zeit_bis = manage(new class Gtk::RadioButton(_RadioBGroup_zeit_2, "bis zum"));
   
   Gtk::Fixed *fixed4 = manage(new class Gtk::Fixed());
   Wdatum_bis = new class Datewin();
   
   Gtk::RadioButton::Group _RadioBGroup_artikel;
   radiobutton_nur_artikel = manage(new class Gtk::RadioButton(_RadioBGroup_artikel, "Zeige nur Artikel"));
   radiobutton_alle_artikel = manage(new class Gtk::RadioButton(_RadioBGroup_artikel, "Zeige alle Artikel"));
   
   Gtk::Fixed *fixed1 = manage(new class Gtk::Fixed());
   Gtk::RadioButton::Group _RadioBGroup_zeit;
   radiobutton_nur_zeit_von = manage(new class Gtk::RadioButton(_RadioBGroup_zeit, "Zeige vom"));
   radiobutton_alle_zeit_von = manage(new class Gtk::RadioButton(_RadioBGroup_zeit, "Zeige vom Anfang"));
   
   Gtk::Fixed *fixed2 = manage(new class Gtk::Fixed());
   Gtk::Table *table15 = manage(new class Gtk::Table(4, 7, false));
   progressbar = manage(new class Gtk::ProgressBar());
   tree = new class SimpleTree(13, 12);
