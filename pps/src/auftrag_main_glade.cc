// generated 2005/9/8 12:48:08 CEST by jacek@jaceksdell.(none)
...
{  auftrag_main = this;
   ...
   Gtk::Label *label110 = manage(new class Gtk::Label(""));
   ...
   info_label_instanzen = manage(new class Gtk::Label(""));
   ...
   {  static GnomeUIInfo main_datei_menu_uiinfo[] = 
      ...
      {       { GNOME_APP_UI_ITEM, "", 0,  0, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  0, (GdkModifierType)0, 0 },
	      { GNOME_APP_UI_ITEM, "", 0,  0, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  0, (GdkModifierType)0, 0 },
	      GNOMEUIINFO_END 
      };
      ...
      {       { GNOME_APP_UI_TOGGLEITEM, "", 0,  0, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  0, (GdkModifierType)0, 0 },
	      GNOMEUIINFO_SEPARATOR, 
      ...
      {       GNOMEUIINFO_MENU_FILE_TREE(main_datei_menu_uiinfo),
	      ...
	      { GNOME_APP_UI_SUBTREE, "", 0,  auftr_ge_menu_uiinfo, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  0, (GdkModifierType)0, 0 },
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ToggleElem("", *manage(new Gtk::Pixmap(stock_convert_rev2_xpm)), 0));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_TRASH_FULL)), 0));
   button_Kunden_erledigt = static_cast<Gtk::Button *>(toolbar1->tools().back()->get_widget());
   
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_LINE_IN)), 0));
