// generated 2003/10/20 14:31:24 CEST by jacek@jaceksdell.(none)
...
{  auftrag_bearbeiten = this;
   ...
   Gtk::Table *table28 = manage(new class Gtk::Table(3, 3, true));
   ...
   table28->attach(*verfuegbar_label, 1, 2, 2, 3, GTK_FILL, 0, 0, 0);
   table28->attach(*bestellt_label, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table28->attach(*button33, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table28->attach(*lieferant_offen, 2, 3, 2, 3, GTK_FILL, 0, 0, 0);
   table28->attach(*offen_bei_lieferant, 2, 3, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   table_auftragseintraege->attach(*table28, 4, 6, 2, 4, GTK_FILL, GTK_FILL, 0, 0);
