// generated 2005/9/8 12:48:09 CEST by jacek@jaceksdell.(none)
...
{  auftrag_bearbeiten = this;
   ...
   Gtk::MenuItem *ean_etiketten_zum_auftrag1;
   Gtk::MenuItem *datei1;
   Gtk::MenuItem *auftrag;
   Gtk::MenuItem *auftragseintr_ge1;
   Gtk::MenuItem *extras1;
   ...
   Gtk::Adjustment *aufrabatt_spinbutton_adj = manage(new class Gtk::Adjustment(0, -100, 100, 1, 10, 10));
   ...
   Gtk::Label *label30 = manage(new class Gtk::Label("Art des Auftrages"));
   ...
   Gtk::Adjustment *rabattentry_spinbutton_adj = manage(new class Gtk::Adjustment(0, -100, 100, 1, 10, 10));
   ...
   offen_bei_lieferant = manage(new class Gtk::Button("L.B."));
   table_vorraetige_menge = manage(new class Gtk::Table(3, 3, false));
   
   Gtk::Label *label73 = manage(new class Gtk::Label("%"));
   mengeeinheit = manage(new class Gtk::Label("kg"));
   WPreis = new class WPreis(false);
   bestellplan = Gtk::wrap((GtkButton*)gnome_stock_button(GNOME_STOCK_BUTTON_HELP));
   
   Gtk::Frame *frame57 = manage(new class Gtk::Frame("Bestellung"));
   ...
   {  static GnomeUIInfo datei1_menu_uiinfo[] = 
      ...
      {       GNOMEUIINFO_MENU_NEW_ITEM("_Neu", "", 0, 0), 
	      ...
	      { GNOME_APP_UI_TOGGLEITEM, "Kombinierte Artikel", 0,  0, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  GDK_F2, (GdkModifierType)0, 0 },
      ...
      static GnomeUIInfo extras1_menu_uiinfo[] = 
      {       { GNOME_APP_UI_ITEM, "EAN Etiketten zum Auftrag", 0,  0, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  0, (GdkModifierType)0, 0 },
	      GNOMEUIINFO_END 
      };
      ...
      {       GNOMEUIINFO_MENU_FILE_TREE(datei1_menu_uiinfo),
	      ...
	      { GNOME_APP_UI_SUBTREE, "", 0,  auftragseintr_ge1_menu_uiinfo, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  0, (GdkModifierType)0, 0 },
	      { GNOME_APP_UI_SUBTREE, "Extras", 0,  extras1_menu_uiinfo, 0, 0, GNOME_APP_PIXMAP_NONE, 0,  0, (GdkModifierType)0, 0 },
	      GNOMEUIINFO_END 
      };
      ...
      kombinierte_artikel = Gtk::wrap(GTK_CHECK_MENU_ITEM(auftrag_menu_uiinfo[3].widget));
      kopieren1 = Gtk::wrap(GTK_MENU_ITEM(auftrag_menu_uiinfo[4].widget));
      trennlinie12 = Gtk::wrap(GTK_MENU_ITEM(auftrag_menu_uiinfo[5].widget));
      provisionierung = Gtk::wrap(GTK_MENU_ITEM(auftrag_menu_uiinfo[6].widget));
      splitten1 = Gtk::wrap(GTK_MENU_ITEM(auftragseintr_ge1_menu_uiinfo[0].widget));
      ean_etiketten_zum_auftrag1 = Gtk::wrap(GTK_MENU_ITEM(extras1_menu_uiinfo[0].widget));
   }
   ...
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_PRINT)), 0));
   ...
   kombinierte_artikel->set_show_toggle(true);
   ...
   table5->attach(*auftrag_label, 3, 4, 3, 4, GTK_FILL, GTK_FILL, 0, 0);
   ...
   offen_bei_lieferant->set_usize(34,-1);
   offen_bei_lieferant->set_flags(GTK_CAN_FOCUS);
   _tooltips.set_tip(*offen_bei_lieferant, "Bestellt beim Lieferanten", "");
   offen_bei_lieferant->set_relief(GTK_RELIEF_NORMAL);
   table_vorraetige_menge->set_row_spacings(0);
   table_vorraetige_menge->set_col_spacings(0);
   table_vorraetige_menge->attach(*lager_bestand, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table_vorraetige_menge->attach(*button31, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table_vorraetige_menge->attach(*lagerbest_label, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table_vorraetige_menge->attach(*button33, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table_vorraetige_menge->attach(*bestellt_label, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table_vorraetige_menge->attach(*verfuegbar_label, 1, 2, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table_vorraetige_menge->attach(*lieferant_offen, 2, 3, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table_vorraetige_menge->attach(*offen_bei_lieferant, 2, 3, 1, 2, GTK_SHRINK|GTK_FILL, 0, 0, 0);
   ...
   bestellplan->set_flags(GTK_CAN_FOCUS);
   bestellplan->set_relief(GTK_RELIEF_NORMAL);
   ...
   table_auftragseintraege->attach(*table_vorraetige_menge, 4, 6, 2, 4, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table_auftragseintraege->attach(*WPreis, 0, 1, 2, 4, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table_auftragseintraege->attach(*frame57, 9, 10, 1, 2, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table_auftragseintraege->attach(*aufentry_abbruch, 9, 10, 2, 3, GTK_FILL, 0, 0, 0);
   table_auftragseintraege->attach(*aufentry_ok, 9, 10, 3, 4, GTK_FILL, 0, 0, 0);
   ...
   auftrag_clist->set_selection_mode(GTK_SELECTION_EXTENDED);
   ...
   frame_notiz->set_label_align(0,0);
   ...
   notiz_paned->pack2(*frame_notiz, false, true);
   ...
   ean_etiketten_zum_auftrag1->activate.connect(SigC::slot(this, &auftrag_bearbeiten_glade::on_ean_etiketten_activate));
   ...
   aufrabatt_spinbutton->activate.connect_after(SigC::slot(this, &auftrag_bearbeiten_glade::on_aufrabatt_spinbutton_activate));
   ...
   auftrag_label->activate.connect(SigC::slot(this, &auftrag_bearbeiten_glade::auftraglabel_geaendert));
   stkmtr_spinbutton->activate.connect_after(SigC::slot(this, &auftrag_bearbeiten_glade::on_stkmtr_spinbutton_activate));
   ...
   rabattentry_spinbutton->activate.connect_after(SigC::slot(this, &auftrag_bearbeiten_glade::on_rabattentry_spinbutton_activate));
   ...
   offen_bei_lieferant->clicked.connect(SigC::slot(this, &auftrag_bearbeiten_glade::on_offen_bei_lieferant_clicked));
   ...
   bestellplan->clicked.connect(SigC::slot(this, &auftrag_bearbeiten_glade::on_bestellplan_clicked));
