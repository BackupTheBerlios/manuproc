// generated 2002/3/7 17:08:58 CET by thoma@Tiger.
...
{   auftrag_rechnung = this;
   ...
   checkbutton_firmenpapier = manage(new class Gtk::CheckButton("Firmenpapier"));
   checkbutton_kopie = manage(new class Gtk::CheckButton("Kopie"));
   ...
   Gtk::Button *button_pr = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar7->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Preise\n"
   ...
   rtree_daten = new class SimpleTree(6, 3);
   ...
   table10->attach(*label_rechnung_ctl, 2, 3, 2, 3, GTK_FILL, 0, 0, 0);
   table10->attach(*rng_WWaehrung, 4, 5, 1, 2, 0, 0, 0, 0);
   table10->attach(*rngnr, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table10->attach(*lieferkunde, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
