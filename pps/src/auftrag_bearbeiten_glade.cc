...
{  auftrag_bearbeiten = this;
   ...
   _data = new GlademmData(auftrag_bearbeiten_accgrp);
   ...
   {  static GnomeUIInfo datei1_menu_uiinfo[] = 
      ...
      gnome_app_fill_menu(GTK_MENU_SHELL(menubar1->gtkobj()), menubar1_uiinfo, _data->getAccelGroup()->gtkobj(), true, 0);
   ...
   _tooltips.set_tip(*newauftrag_button, "neuer Auftrag: Kunde eingeben, dann hier drücken, dann Kundenauftrag eingeben, dann oberes OK anwählen", "");
   ...
   table_auftragseintraege->attach(*preisautomatik, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   notiz_paned->set_position(220);
   notiz_paned->pack1(*scrolledwindow_auftraege, false, true);
   notiz_paned->pack2(*frame24, true, true);
   aufeintrag_box->pack_start(*frame3);
   ...
   auftrag_bearbeiten->add_accel_group(*(_data->getAccelGroup()));
   ...
   checkbutton_ean_drucken->clicked.connect_after(SigC::slot(static_cast<class auftrag_bearbeiten*>(this), &auftrag_bearbeiten::on_checkbutton_ean_drucken_clicked));
   ...
   preisautomatik->clicked.connect(SigC::slot(static_cast<class auftrag_bearbeiten*>(this), &auftrag_bearbeiten::on_preisautomatik_clicked));
   ...
   notiz->changed.connect(SigC::slot(static_cast<class auftrag_bearbeiten*>(this), &auftrag_bearbeiten::on_notiz_changed));
   notiz_save->clicked.connect(SigC::slot(static_cast<class auftrag_bearbeiten*>(this), &auftrag_bearbeiten::on_notiz_save_clicked));
}
