...
{  
   ...
   preisliste = new class KundenBox();
   ...
   table10->set_row_spacings(4);
   table10->set_col_spacings(2);
   table10->attach(*preismenge, 0, 1, 3, 4, Gtk::EXPAND|Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table10->attach(*einheit, 1, 2, 3, 4, Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table10->attach(*preis, 0, 1, 2, 3, Gtk::EXPAND|Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table10->attach(*preisliste, 0, 3, 0, 1, Gtk::FILL, Gtk::EXPAND|Gtk::FILL, 0, 0);
   table10->attach(*hseparator1, 0, 3, 1, 2, Gtk::FILL, Gtk::FILL, 0, 0);
   table10->attach(*waehrung, 1, 3, 2, 3, Gtk::EXPAND|Gtk::FILL, Gtk::FILL, 0, 0);
   table10->attach(*image_preis_ok, 2, 3, 3, 4, Gtk::FILL, Gtk::FILL, 0, 0);
   ...
   top_notebook->pages().back().set_tab_label_packing(false, true, Gtk::PACK_START);
   top_notebook->append_page(*table10, *label22);
   top_notebook->pages().back().set_tab_label_packing(false, true, Gtk::PACK_START);
   ...
   preismenge->signal_activate().connect(SigC::slot(*this, &Artikeleingabe_glade::preismenge_activate), true);
   preis->signal_activate().connect(SigC::slot(*this, &Artikeleingabe_glade::activate_preis), true);
   preisliste->signal_activate().connect(SigC::slot(*this, &Artikeleingabe_glade::andere_Liste));
   waehrung->signal_activate().connect(SigC::slot(*this, &Artikeleingabe_glade::waehrung_deactivate));
