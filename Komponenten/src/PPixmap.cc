...
Gtk::Pixmap *PPixmap::getPixProz(double x)
{
  ...
  if(x<.10)   return manage(new Gtk::Pixmap(vpix[0].map(),vpix[0].mask()));
  if(x<.20)   return manage(new Gtk::Pixmap(vpix[1].map(),vpix[1].mask()));
  if(x<.30)   return manage(new Gtk::Pixmap(vpix[2].map(),vpix[2].mask()));
  if(x<.40)   return manage(new Gtk::Pixmap(vpix[3].map(),vpix[3].mask()));
  if(x<.50)   return manage(new Gtk::Pixmap(vpix[4].map(),vpix[4].mask()));
  if(x<.60)   return manage(new Gtk::Pixmap(vpix[5].map(),vpix[5].mask()));
  if(x<.70)   return manage(new Gtk::Pixmap(vpix[6].map(),vpix[6].mask()));
  if(x<.80)   return manage(new Gtk::Pixmap(vpix[7].map(),vpix[7].mask()));
  if(x<.90)   return manage(new Gtk::Pixmap(vpix[8].map(),vpix[8].mask()));
  if(x<1.0)   return manage(new Gtk::Pixmap(vpix[9].map(),vpix[9].mask()));
  if(x==1.)   return manage(new Gtk::Pixmap(vpix[10].map(),vpix[10].mask()));
...
{
  return manage(new Gtk::Pixmap(vpix_[0].map(),vpix_[0].mask()));
}
