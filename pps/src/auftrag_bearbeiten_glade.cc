// generated 2005/1/27 11:11:39 CET by jacek@jaceksdell.(none)
...
{  auftrag_bearbeiten = this;
   ...
   masseneingabe1->set_active(true);
   ...
   table_auftragseintraege->attach(*frame57, 11, 12, 1, 2, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
