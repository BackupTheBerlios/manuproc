...
//#endif         
	    ...
	    fixedpoint<2> preis;
	    if(Rueckstand())
            	preis = (*k).getPreis().Gesamtpreis(getWaehrung(),(*k).Rest(),(*k).Menge(),(*k).Rabatt());
	    else
            	preis = (*k).getPreis().Gesamtpreis(getWaehrung(),(*k).Stueck(),(*k).Menge(),(*k).Rabatt());
