// generated 2006/5/11 17:51:07 CEST by christof@vesta.petig-baender.de
...
{  
   ...
   database_default = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_database_default, _("Shindo GmbH")));
   database_OLD = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_database_default, _("Shindo Ltd.")));
   db_table = Gtk::manage(new class Gtk::Table(2, 2, false));
   
   Gtk::Alignment *alignment3 = Gtk::manage(new class Gtk::Alignment(0.5, 0.5, 1, 1));
   Gtk::Label *db_label = Gtk::manage(new class Gtk::Label(_("<b>Datenbank</b>")));
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   fibu_start = Gtk::manage(new class Gtk::ToolButton(*fibu_start_img, _("FiBu")));
#endif //
   
   Gtk::Image *fibu_alt_start_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-sort-ascending"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   fibu_alt_start = Gtk::manage(new class Gtk::ToolButton(*fibu_alt_start_img, _("FiBu (ALT)")));
#endif //
   
   Gtk::Image *taxbird_start_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-network"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   taxbird_start = Gtk::manage(new class Gtk::ToolButton(*taxbird_start_img, _("ELSTER (USt)")));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   vertrieb_start = Gtk::manage(new class Gtk::ToolButton(*vertrieb_start_img, _("Vertrieb")));
#endif //
   
   Gtk::Image *ooo_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-select-font"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   ooo = Gtk::manage(new class Gtk::ToolButton(*ooo_img, _("OpenOffice")));
#endif //
   
   Gtk::Image *preview_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-dialog-error"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   preview = Gtk::manage(new class Gtk::ToolButton(*preview_img, _("(vorab)")));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   quit = Gtk::manage(new class Gtk::ToolButton(*quit_img, _("Beenden")));
#endif //
   
   Gtk::Toolbar *toolbar1 = Gtk::manage(new class Gtk::Toolbar());
   Gtk::Image *kunden_neu_start_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-open"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   kunden_neu_start = Gtk::manage(new class Gtk::ToolButton(*kunden_neu_start_img, _("Kunden Gtk-2")));
#endif //
   ...
   Gtk::Label *label2 = Gtk::manage(new class Gtk::Label(_("<b>Programme</b>")));
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   lagerwert = Gtk::manage(new class Gtk::ToolButton(*lagerwert_img, _("Lagerwert")));
#endif //
   
   Gtk::Image *offeneposten_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-dialog-info"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   offeneposten = Gtk::manage(new class Gtk::ToolButton(*offeneposten_img, _("offene Posten")));
#endif //
   
   Gtk::Image *translate_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-copy"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   translate = Gtk::manage(new class Gtk::ToolButton(*translate_img, _("Übersetzen")));
#endif //
   ...
   Gtk::Label *label1 = Gtk::manage(new class Gtk::Label(_("<b>Skripte / Auswertungen</b>")));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("PPS"), *pps_start_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Kunden"), *kunden_start_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Lager"), *lager_start_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Artikel"), *artikel_start_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Preislisten"), *preise_start_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("FiBu"), *fibu_start_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("FiBu (ALT)"), *fibu_alt_start_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("ELSTER (USt)"), *taxbird_start_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Vertrieb"), *vertrieb_start_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("OpenOffice"), *ooo_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("(vorab)"), *preview_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Beenden"), *quit_img, Gtk::Toolbar_Helpers::Callback0()));
   quit = static_cast<Gtk::Button *>(toolbar1->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolbar3->append(*kunden_neu_start);
#else //
   
   
   toolbar3->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Kunden Gtk-2"), *kunden_neu_start_img, Gtk::Toolbar_Helpers::Callback0()));
   kunden_neu_start = static_cast<Gtk::Button *>(toolbar3->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   ...
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Lagerwert"), *lagerwert_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("offene Posten"), *offeneposten_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem(_("Übersetzen"), *translate_img, Gtk::Toolbar_Helpers::Callback0()));
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   kunden_neu_start->set_visible_horizontal(true);
   kunden_neu_start->set_visible_vertical(true);
   kunden_neu_start->set_is_important(false);
   kunden_neu_start->set_homogeneous(true);
   kunden_neu_start->set_expand(false);
#endif //
   kunden_neu_start_img->show();
   ...
   vbox2->pack_start(*toolbar3, Gtk::PACK_SHRINK, 0);
   ...
   _tooltips.set_tip(*lagerwert, _("zeigt & druckt die Lagerbewertung zum gewünschten Stichtag"), "");
   ...
   lagerwert->set_tooltip(_tooltips, _("zeigt & druckt die Lagerbewertung zum gewünschten Stichtag"));
#endif //
   lagerwert_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   offeneposten->set_sensitive(false);
   _tooltips.set_tip(*offeneposten, _("zeigt & druckt die Liste der offenen Posten"), "");
   ...
   offeneposten->set_tooltip(_tooltips, _("zeigt & druckt die Liste der offenen Posten"));
#endif //
   ...
   ManuProc_Starter->set_title(_("ManuProC_Starter"));
   ...
   kunden_neu_start->signal_clicked().connect(SigC::slot(*this, &ManuProc_Starter_glade::on_kunden_neu_start_enter), false);
