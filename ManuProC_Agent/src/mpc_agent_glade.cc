// generated 2004/5/13 16:04:53 CEST by jacek@jaceksdell.(none)
...
{  
   ...
   notebook1->append_page(*hbox6, *label10);
   notebook1->pages().back().set_tab_label_packing(false, true, Gtk::PACK_START);
   notebook1->append_page(*frame10, *label11);
   notebook1->pages().back().set_tab_label_packing(false, false, Gtk::PACK_START);
   hbox_artikel->pack_start(*notebook1, Gtk::PACK_SHRINK, 0);
