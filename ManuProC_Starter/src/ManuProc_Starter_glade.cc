...
{  
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Preislisten", *manage(new Gtk::Image(Gtk::StockID("gtk-justify-fill"), Gtk::ICON_SIZE_LARGE_TOOLBAR)), Gtk::Toolbar_Helpers::Callback0()));
   ...
   preise_start->signal_clicked().connect(SigC::slot(*this, &ManuProc_Starter_glade::on_preise_start_clicked));
