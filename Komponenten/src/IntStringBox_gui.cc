// $Id: IntStringBox_gui.cc,v 1.3 2003/03/17 16:28:41 christof Exp $
...
void IntStringBox_gui::fuelleMenu()
{
  ...
  menu=new IntStringPopup_glade();
  menu->zurueck->signal_activate().connect(SigC::slot(*this,&IntStringBox_gui::reset));
}
