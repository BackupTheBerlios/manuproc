// generated 2003/10/22 16:17:01 CEST by jacek@jaceksdell.(none)
...
{  auftrag_bearbeiten = this;
   ...
   Gtk::Table *table28 = manage(new class Gtk::Table(3, 3, false));
   ...
   table28->attach(*lieferant_offen, 2, 3, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table28->attach(*offen_bei_lieferant, 2, 3, 1, 2, GTK_SHRINK|GTK_FILL, 0, 0, 0);
