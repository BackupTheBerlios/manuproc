...
{  
   ...
   vbox1->show();
   window1->show();
   Beenden->activate.connect(SigC::slot(this, &window1_glade::on_Beenden_activate));
   WPreis->activate.connect(SigC::slot(this, &window1_glade::on_activate_wpreis));
   custom_OI->activate.connect(SigC::slot(this, &window1_glade::OI_activate));
   custom_OW->activate.connect(SigC::slot(this, &window1_glade::OW_activate));
   button1->clicked.connect(SigC::slot(this, &window1_glade::on_show_clicked));
   WWaehrung->activate.connect(SigC::slot(this, &window1_glade::on_activate_wwaehrung));
   datum->activate.connect(prozess->grab_focus.slot());
   prozess->activate.connect(artikelbox->grab_focus.slot());
   artikelbox->activate.connect(SigC::slot(this, &window1_glade::on_show_complete));
   kundenbox->activate.connect(SigC::slot(this, &window1_glade::andererKunde));
   button2->clicked.connect(SigC::slot(this, &window1_glade::on_reset));
}
