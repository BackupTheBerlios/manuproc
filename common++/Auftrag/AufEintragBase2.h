// $Id: AufEintragBase2.h,v 1.38 2002/01/09 14:55:29 cvs_malte Exp $
...
public:
 ...
 AufEintragBase2(cH_ppsInstanz inst,int auftragid,int z) 
 	:  AuftragBase(inst,auftragid), zeilennr(z) {}
 AufEintragBase2(const AuftragBase& a,int z) 
