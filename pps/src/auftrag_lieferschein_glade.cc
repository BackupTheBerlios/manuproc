// generated 2003/6/16 15:07:25 CEST by jacek@jaceksdell.(none)
...
{  auftrag_lieferschein = this;
   ...
   auftragnr->activate.connect(SigC::slot(Palette, &Gtk::Widget::grab_focus));
   ...
   liefermenge->activate.connect(SigC::slot(auftragnr, &Gtk::Widget::grab_focus));
