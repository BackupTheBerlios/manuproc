// generated 2005/4/22 17:33:32 CEST by christof@vesta.petig-baender.de
...
{  
   ...
   beenden->set_homogeneous(true);
   beenden->set_expand(false);
#endif //
   beenden_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   ...
   neu->set_homogeneous(true);
   neu->set_expand(false);
#endif //
   neu_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   ...
   senden->set_homogeneous(true);
   senden->set_expand(false);
#endif //
   senden_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   ...
   clear->set_homogeneous(true);
   clear->set_expand(false);
#endif //
   clear_img->show();
   ...
   customer_search->set_is_important(true);
   customer_search->set_homogeneous(true);
   customer_search->set_expand(false);
#endif //
   ...
   hbox7->pack_start(*article_entry);
   ...
   frame9->add(*color_entry);
   frame9->set_label_widget(*label15);
   hbox10->pack_start(*makeup_entry);
   ...
   artikel_ok->set_is_important(true);
   artikel_ok->set_homogeneous(true);
   artikel_ok->set_expand(false);
#endif //
   artikel_ok_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   ...
   artikel_cancel->set_is_important(true);
   artikel_cancel->set_homogeneous(true);
   artikel_cancel->set_expand(false);
#endif //
   ...
   artikel_del->set_is_important(true);
   artikel_del->set_homogeneous(true);
   artikel_del->set_expand(false);
#endif //
