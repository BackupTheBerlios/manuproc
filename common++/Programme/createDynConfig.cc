// $Id: createDynConfig.cc,v 1.7 2005/11/17 11:42:02 christof Exp $
...
{  std::string res;
   ...
   {  if (*i==0xe4) res+="ae";
      else if (*i==0xf6) res+="oe";
      else if (*i==0xfc) res+="ue";
      else if (*i==0xdf) res+="ss";
      else if (*i==0xc4) res+="Ae";
      else if (*i==0xd6) res+="Oe";
      else if (*i==0xdc) res+="Ue";
