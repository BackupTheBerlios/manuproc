...
{   auftrag_lieferschein = this;
   ...
   lieferschein_liste = new class Lief_TCList(4, 3);
   ...
   Gtk::Label *label52 = manage(new class Gtk::Label("Kundenauftrag"));
   ...
   Gtk::Adjustment *Palette_adj = manage(new class Gtk::Adjustment(1, 0, 100, 1, 10, 10));
   ...
   Gtk::Label *label65 = manage(new class Gtk::Label("Menge"));
   Gtk::Table *table9 = manage(new class Gtk::Table(2, 6, false));
   offene_auftraege = new class OffAuf_TCList(5, 3);
   ...
   frame4->add(*table8);
   viewport1->add(*lieferschein_liste);
   ...
   table9->attach(*label52, 3, 4, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   table9->attach(*label65, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   scrolledwindow5->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   scrolledwindow5->add(*offene_auftraege);
   vbox6->pack_start(*table9, false, true, 0);
   vbox6->pack_start(*scrolledwindow5);
   ...
   lieferschein_liste->select_row.connect(SigC::slot(static_cast<class auftrag_lieferschein*>(this), &auftrag_lieferschein::on_selectrow_lieferschein));
   lieferschein_liste->unselect_row.connect(SigC::slot(static_cast<class auftrag_lieferschein*>(this), &auftrag_lieferschein::on_unselectrow_lieferschein));
   ...
   offene_auftraege->select_row.connect(SigC::slot(static_cast<class auftrag_lieferschein*>(this), &auftrag_lieferschein::on_selectrow_offauf));
   offene_auftraege->unselect_row.connect(SigC::slot(static_cast<class auftrag_lieferschein*>(this), &auftrag_lieferschein::on_unselectrow_offauf));
   glademm_set_Widget("auftrag_lieferschein", this);
}
...
{   delete liefdate;
   delete liefernr;
   delete liefer_kunde;
   delete lieferschein_liste;
   delete artikelbox;
   delete offene_auftraege;
}
