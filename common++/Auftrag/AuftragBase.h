...
class AuftragBase
{
 ...
 public:
   ...
   static const ID handplan_auftrag_id =  3; // gemeint sind alle Auftr�e, die NICHT 0,1,2 sind
...
//   static const ID auffuellen_id =  3; // Mindestmengenbestellung im Lager
 ...
 public:
   ...
   // Varianten fr negative Zahlen??? kommt h�figer vor?
