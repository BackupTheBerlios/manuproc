// generated 2002/9/23 11:19:39 MEST by jacek@ijacek.jacek.de
...
{  auftrag_lieferschein = this;
   ...
   _data = new GlademmData(auftrag_lieferschein_accgrp);
   ...
   {  static GnomeUIInfo datei2_menu_uiinfo[] = 
      ...
      gnome_app_fill_menu(GTK_MENU_SHELL(menubar2->gtkobj()), menubar2_uiinfo, _data->getAccelGroup()->gtkobj(), true, 0);
   ...
   table_mabella = manage(new class Gtk::Table(1, 5, false));
   ...
   frame23->add(*hbox17);
   table_mabella->set_row_spacings(0);
   table_mabella->set_col_spacings(0);
   ...
   auftrag_lieferschein->add_accel_group(*(_data->getAccelGroup()));
   ...
   checkbutton_ean_drucken->clicked.connect_after(SigC::slot(static_cast<class auftrag_lieferschein*>(this), &auftrag_lieferschein::on_checkbutton_ean_drucken_clicked));
   ...
   button_rng_erledigt->clicked.connect(SigC::slot(static_cast<class auftrag_lieferschein*>(this), &auftrag_lieferschein::on_button_rng_erledigt_clicked));
