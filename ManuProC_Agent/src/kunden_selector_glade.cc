...
{  
   ...
   cancel_kunde_select->set_flags(Gtk::CAN_DEFAULT);
   ...
   ok_kunde_select->set_flags(Gtk::CAN_DEFAULT);
   ...
   cancel_kunde_select->signal_clicked().connect(SigC::slot(*this, &kunden_selector_glade::on_cancel_kunde_select_clicked), false);
   ok_kunde_select->signal_clicked().connect(SigC::slot(*this, &kunden_selector_glade::on_ok_kunde_select_clicked), false);
