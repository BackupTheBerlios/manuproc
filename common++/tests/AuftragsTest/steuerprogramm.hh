// $Id: steuerprogramm.hh,v 1.4 2002/06/26 09:04:27 christof Exp $
...
#define PLANDATUM4 Petig::Datum(4,4,2004)
#define PLANDATUM5 Petig::Datum(5,5,2005)
#define PLANDATUM6 Petig::Datum(6,6,2006)
