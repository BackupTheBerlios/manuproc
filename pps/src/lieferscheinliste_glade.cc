...
{  
   ...
   first_komponent = manage(new class Gtk::CheckButton("", 0, 0.5));
   ...
   toolbar11->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_EXIT)), 0));
