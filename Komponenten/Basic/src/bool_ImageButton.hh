// $Id: bool_ImageButton.hh,v 1.1 2003/03/07 08:10:25 christof Exp $
...
public:
	bool_ImageButton(const Model_ref<T> &model, Glib::RefPtr<Gdk::Pixmap> off, Glib::RefPtr<Gdk::Pixmap> on);
};
