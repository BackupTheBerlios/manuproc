// generated 2005/9/12 12:40:07 CEST by jacek@woody.mabella.de
...
{  auftrag_main = this;
   ...
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Erledigt", *Gtk::wrap(gnome_stock_pixmap_widget(GTK_WIDGET(gtkobj()), GNOME_STOCK_PIXMAP_TRASH_FULL)), 0));
