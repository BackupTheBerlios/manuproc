// generated 2004/5/11 15:46:07 CEST by jacek@jaceksdell.(none)
...
{  
   ...
   Gtk::Adjustment *menge_adj = Gtk::manage(new class Gtk::Adjustment(1, 0, 1000, 1, 10, 10));
   ...
   order_search->set_sensitive(false);
   order_clear->set_sensitive(false);
   ...
   menge->signal_editing_done().connect(SigC::slot(*this, &mpc_agent_glade::on_menge_editing_done));
